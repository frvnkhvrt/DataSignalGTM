...
export function DashboardAnalyticsShell({
  ...
  return (
    <div
      className={cn(
        "@container/analytics relative space-y-4 rounded-2xl border border-border/50 bg-card/42 p-4 shadow-soft ring-1 ring-black/[0.04] backdrop-blur-xl dark:bg-card/30 dark:ring-white/[0.06] sm:space-y-5 sm:p-5 lg:p-6",
        "ds-card-inner-glow",
