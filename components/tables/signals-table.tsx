...
export function SignalsTable({
  ...
  return (
    <div className="min-w-0 space-y-4">
      ...
      />
      <DynamicGlassCard layoutId="signals-table-toolbar-card" className="relative flex min-w-0 flex-col gap-3 overflow-hidden p-3 md:flex-row md:items-center md:justify-between md:gap-4">
        {isRefetching && (
      ...
      <DynamicGlassCard layoutId="signals-table-content-card" className="min-w-0 p-0" aria-busy={isLoading || isRefetching}>
