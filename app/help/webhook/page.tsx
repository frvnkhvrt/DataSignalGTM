...
export default function WebhookPage() {
  return (
    <article className="space-y-8 text-muted-foreground">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Webhook Integration</h1>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm">
          ...
          signals are <strong className="text-foreground">upserted</strong> — if an
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm">
          Set <code className="rounded bg-muted px-1 py-0.5 text-xs text-foreground">SIGNAL_WEBHOOK_SECRET</code> in
...
POST /api/webhooks/signals?secret=<SIGNAL_WEBHOOK_SECRET>
        ...
        <p className="text-sm text-amber-400">
          ⚠ If <code className="rounded bg-muted px-1 py-0.5 text-xs">SIGNAL_WEBHOOK_SECRET</code> is not set, the
  ...
  "external_id":   "6s-acme-20260510"  // optional — deduplication key
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-foreground">Batch example</h2>
        <CodeBlock>{`[
  ...
  -d '{
    ...
    "velocity_score": 85
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-foreground">Finding your org_id</h2>
        <p className="text-sm">
          Your organisation UUID is shown in the top-right of the app. You can
          also find it in <strong className="text-foreground">Settings → Billing</strong> or
